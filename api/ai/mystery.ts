...
4. answer 是完整答案，30-100 字，解释清楚推理过程
5. keywords 是 3-5 个关键词，便于判断玩家回答是否命中关键信息
6. title 是简短标题（2-6 字）
7. category 只能是"逻辑推理"、"密码解谜"或"找线索"
8. 难度 ${difficulty}：simple 较直白，medium 需要一步推理，hard 需要多步推理
